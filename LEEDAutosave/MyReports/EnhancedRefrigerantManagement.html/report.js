$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ScoreCard/EnhancedRefrigerantManagement.feature");
formatter.feature({
  "name": "Entering data to Enhanced Refrigerant Management - LEED v4.1 O+M: EB",
  "description": "",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Filling Enhanced Refrigerant Management form for No Refrigerants or Low-Impact Refrigerants",
  "description": "",
...
formatter.step({
  "name": "User should be on form Enhanced Refrigerant Management-noRefrigOrLowImpact rating O+M:EB",
  "keyword": "And "
});
formatter.match({
...
formatter.scenarioOutline({
  "name": "Filling Enhanced Refrigerant Management form for Calculation of Refrigerant Impact",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.examples({
  ...
  "rows": [
    ...
    {
      "cells": [
        "Enhanced Refrigerant Management-calcRefrigerantImpact",
        "BDD6 TestProject",
        "O+M:EB",
        "Table: Mechanical Cooling and Refrigeration Equipment",
        "TD_MechanicalCoolingandRefrigerationEquipment",
        "Yes"
      ]
    }
  ]
...
formatter.step({
  "name": "User should be on form Enhanced Refrigerant Management-calcRefrigerantImpact rating O+M:EB",
  "keyword": "And "
});
formatter.match({
  "location": "FundamentalRefregrantMgmt.user_should_be_on_FRM_form(String,String)"
...
formatter.step({
  "name": "User fills the table Table: Mechanical Cooling and Refrigeration Equipment with data TD_MechanicalCoolingandRefrigerationEquipment isAddRow Yes",
  "keyword": "And "
});
formatter.match({
...
formatter.scenarioOutline({
  "name": "Checking Auto Save functionality in Enhanced Refrigerant Management form for No Refrigerants or Low-Impact Refrigerants",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.step({
  "name": "User Enters data to Narrative field to check auto save on form Enhanced Refrigerant Management-noRefrigOrLowImpact rating O+M:EB",
  "keyword": "And "
});
formatter.match({
...
formatter.scenarioOutline({
  "name": "Checking Auto Save functionality in Enhanced Refrigerant Management form for Calculation of Refrigerant Impact",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.step({
  "name": "User Enters data to Narrative field to check auto save on form Enhanced Refrigerant Management-calcRefrigerantImpact rating O+M:EB",
  "keyword": "And "
});
formatter.match({
  "location": "AutoSaveStepDef.user_enters_data_to_Narrative_field(String,String)"
...
formatter.result({
  "error_message": "java.lang.NullPointerException: Cannot invoke method log() on null object\r\n\tat org.codehaus.groovy.runtime.NullObject.invokeMethod(NullObject.java:91)\r\n\tat org.codehaus.groovy.runtime.callsite.PogoMetaClassSite.call(PogoMetaClassSite.java:48)\r\n\tat org.codehaus.groovy.runtime.callsite.CallSiteArray.defaultCall(CallSiteArray.java:48)\r\n\tat org.codehaus.groovy.runtime.callsite.NullCallSite.call(NullCallSite.java:35)\r\n\tat org.codehaus.groovy.runtime.callsite.CallSiteArray.defaultCall(CallSiteArray.java:48)\r\n\tat org.codehaus.groovy.runtime.callsite.PogoMetaClassSite.call(PogoMetaClassSite.java:57)\r\n\tat org.codehaus.groovy.runtime.callsite.AbstractCallSite.call(AbstractCallSite.java:133)\r\n\tat AutoSaveStepDef.user_enters_data_to_Narrative_field(AutoSaveStepDef.groovy:206)\r\n\tat ✽.User Enters data to Narrative field to check auto save on form Enhanced Refrigerant Management-calcRefrigerantImpact rating O+M:EB(Include/features/ScoreCard/EnhancedRefrigerantManagement.feature:81)\r\n",
  "status": "failed"
});
formatter.step({
  "name": "User uploads files to Add file button to check auto save on form Enhanced Refrigerant Management-calcRefrigerantImpact rating O+M:EB",
  "keyword": "And "
});
formatter.match({
  "location": "AutoSaveStepDef.user_uploads_files_to_Add_file_button(String,String)"
