$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ScoreCard/Grid Harmonization.feature");
formatter.feature({
  "name": "Entering data to Grid Harmonization form - LEED v4.1 O+M: EB",
  "description": "",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Filling Grid Harmonization form for Demand response program available and participation",
  "description": "",
...
formatter.step({
  "name": "User should be on form Grid Harmonization-demandResProgramAvail rating O+M:EB",
  "keyword": "And "
});
formatter.match({
...
formatter.scenarioOutline({
  "name": "Filling Grid Harmonization form for Demand response capable building",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.step({
  "name": "User should be on form Grid Harmonization-demandResCapableBuilding rating O+M:EB",
  "keyword": "And "
});
formatter.match({
  "location": "FundamentalRefregrantMgmt.user_should_be_on_FRM_form(String,String)"
...
formatter.scenarioOutline({
  "name": "Filling Grid Harmonization form for Permanent load shifting technologies",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.step({
  "name": "User should be on form Grid Harmonization-permLoadShiftTechnologies rating O+M:EB",
  "keyword": "And "
});
formatter.match({
  "location": "FundamentalRefregrantMgmt.user_should_be_on_FRM_form(String,String)"
...
formatter.scenarioOutline({
  "name": "Checking Auto Save functionality in Grid Harmonization form for Demand response program available and participation",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.step({
  "name": "User should be on form \u003cformname\u003e rating \u003cratingSystem\u003e    When User will select the Radio Button",
  "keyword": "And "
});
formatter.step({
...
formatter.step({
  "name": "User should be on form Grid Harmonization-demandResCapableBuilding rating O+M:EB    When User will select the Radio Button",
  "keyword": "And "
});
formatter.match({
  "location": "FundamentalRefregrantMgmt.user_should_be_on_FRM_form(String,String)"
...
formatter.step({
  "name": "User Enters data to Narrative field to check auto save on form Grid Harmonization-demandResCapableBuilding rating O+M:EB",
  "keyword": "And "
});
formatter.match({
...
formatter.scenarioOutline({
  "name": "Checking Auto Save functionality in Grid Harmonization form for Permanent load shifting technologies",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.step({
  "name": "User Enters data to Narrative field to check auto save on form Grid Harmonization-permLoadShiftTechnologies rating O+M:EB",
  "keyword": "And "
});
formatter.match({
  "location": "AutoSaveStepDef.user_enters_data_to_Narrative_field(String,String)"
...
formatter.result({
  "error_message": "java.lang.NullPointerException: Cannot invoke method log() on null object\r\n\tat org.codehaus.groovy.runtime.NullObject.invokeMethod(NullObject.java:91)\r\n\tat org.codehaus.groovy.runtime.callsite.PogoMetaClassSite.call(PogoMetaClassSite.java:48)\r\n\tat org.codehaus.groovy.runtime.callsite.CallSiteArray.defaultCall(CallSiteArray.java:48)\r\n\tat org.codehaus.groovy.runtime.callsite.NullCallSite.call(NullCallSite.java:35)\r\n\tat org.codehaus.groovy.runtime.callsite.CallSiteArray.defaultCall(CallSiteArray.java:48)\r\n\tat org.codehaus.groovy.runtime.callsite.PogoMetaClassSite.call(PogoMetaClassSite.java:57)\r\n\tat org.codehaus.groovy.runtime.callsite.AbstractCallSite.call(AbstractCallSite.java:133)\r\n\tat AutoSaveStepDef.user_enters_data_to_Narrative_field(AutoSaveStepDef.groovy:206)\r\n\tat ✽.User Enters data to Narrative field to check auto save on form Grid Harmonization-permLoadShiftTechnologies rating O+M:EB(Include/features/ScoreCard/Grid Harmonization.feature:104)\r\n",
  "status": "failed"
});
formatter.step({
  "name": "User uploads files to Add file button to check auto save on form Grid Harmonization-permLoadShiftTechnologies rating O+M:EB",
  "keyword": "And "
});
formatter.match({
  "location": "AutoSaveStepDef.user_uploads_files_to_Add_file_button(String,String)"
