$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ScoreCard/EnvironmentalTobaccoSmokeControl.feature");
formatter.feature({
  "name": "Entering data to Environmental Tobacco Smoke Control form - LEED v4.1 O+M: EB",
  "description": "",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Filling Environmental Tobacco Smoke Control for NoSmoking",
  "description": "",
...
formatter.step({
  "name": "User should be on form Environmental Tobacco Smoke Control-NoSmoking rating O+M:EB",
  "keyword": "And "
});
formatter.match({
...
formatter.scenarioOutline({
  "name": "Filling Environmental Tobacco Smoke Control for CompartmentalizationSmokeAreas",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.step({
  "name": "User should be on form Environmental Tobacco Smoke Control-CompartmentalizationSmokeAreas rating O+M:EB",
  "keyword": "And "
});
formatter.match({
  "location": "FundamentalRefregrantMgmt.user_should_be_on_FRM_form(String,String)"
...
formatter.scenarioOutline({
  "name": "Checking Auto Save functionality in Environmental Tobacco Smoke Control-NoSmoking form for Economic Analysis",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.step({
  "name": "User Enters data to Narrative field to check auto save on form Environmental Tobacco Smoke Control-NoSmoking rating O+M:EB",
  "keyword": "And "
});
formatter.match({
...
formatter.scenarioOutline({
  "name": "Checking Auto Save functionality in Environmental Tobacco Smoke Control-CompartmentalizationSmokeAreas form for Economic Analysis",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.step({
  "name": "User Enters data to Narrative field to check auto save on form Environmental Tobacco Smoke Control-CompartmentalizationSmokeAreas rating O+M:EB",
  "keyword": "And "
});
formatter.match({
  "location": "AutoSaveStepDef.user_enters_data_to_Narrative_field(String,String)"
...
formatter.result({
  "error_message": "java.lang.NullPointerException: Cannot invoke method log() on null object\r\n\tat org.codehaus.groovy.runtime.NullObject.invokeMethod(NullObject.java:91)\r\n\tat org.codehaus.groovy.runtime.callsite.PogoMetaClassSite.call(PogoMetaClassSite.java:48)\r\n\tat org.codehaus.groovy.runtime.callsite.CallSiteArray.defaultCall(CallSiteArray.java:48)\r\n\tat org.codehaus.groovy.runtime.callsite.NullCallSite.call(NullCallSite.java:35)\r\n\tat org.codehaus.groovy.runtime.callsite.CallSiteArray.defaultCall(CallSiteArray.java:48)\r\n\tat org.codehaus.groovy.runtime.callsite.PogoMetaClassSite.call(PogoMetaClassSite.java:57)\r\n\tat org.codehaus.groovy.runtime.callsite.AbstractCallSite.call(AbstractCallSite.java:133)\r\n\tat AutoSaveStepDef.user_enters_data_to_Narrative_field(AutoSaveStepDef.groovy:206)\r\n\tat ✽.User Enters data to Narrative field to check auto save on form Environmental Tobacco Smoke Control-CompartmentalizationSmokeAreas rating O+M:EB(Include/features/ScoreCard/EnvironmentalTobaccoSmokeControl.feature:84)\r\n",
  "status": "failed"
});
formatter.step({
  "name": "User uploads files to Add file button to check auto save on form Environmental Tobacco Smoke Control-CompartmentalizationSmokeAreas rating O+M:EB",
  "keyword": "And "
});
formatter.match({
  "location": "AutoSaveStepDef.user_uploads_files_to_Add_file_button(String,String)"
