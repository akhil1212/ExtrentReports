$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ScoreCard/SiteManagement.feature");
formatter.feature({
...
formatter.step({
  "name": "User should be on form Site Management rating O+M:EB",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "User Enters data to Narrative field to check auto save on form Site Management rating O+M:EB",
  "keyword": "And "
});
formatter.match({
