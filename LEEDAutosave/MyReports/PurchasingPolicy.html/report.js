$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ScoreCard/Purchasing Policy.feature");
formatter.feature({
  "name": "Entering data to Purchasing Policy form - LEED v4.1 O+M: EB",
  "description": "",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Filling Purchasing Policy form",
  "description": "",
...
formatter.step({
  "name": "User should be on form Purchasing Policy rating O+M:EB",
  "keyword": "And "
});
formatter.match({
...
formatter.scenarioOutline({
  "name": "Checking Auto Save functionality in Purchasing Policy form",
  "description": "",
  "keyword": "Scenario Outline",
  "tags": [
    {
...
formatter.step({
  "name": "User Enters data to Narrative field to check auto save on form Purchasing Policy rating O+M:EB",
  "keyword": "And "
});
formatter.match({
